...
class _DPSState extends State<DPS> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("DPS", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        centerTitle: true,
        ...
        child: Column(children: [
          Padding(padding: EdgeInsets.all(5),
            child: Row(
              ...
              children: [
                Image.asset("assets/images/Genji.png", width: 190, height: 190),
                Expanded(
                  child: Column(children: [
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Image.asset("assets/images/Tracer.png", width: 190, height: 190),
                  Expanded(
                    child: Column(
                      children: [
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Image.asset("assets/images/Widow.png", width: 190, height: 190),
                Expanded(
                  child: Column(children: [
